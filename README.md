...
LastTurns 默认不上传聊天内容，不读取账号信息，也不会将对话发送到外部服务器。
...
**Repository:** [NaerDD/lastturns-extension](https://github.com/NaerDD/lastturns-extension)
...
This is useful when the site layout has changed, a previous manual selection was inaccurate, or you want LastTurns to re-detect the chat structure from scratch.
...
LastTurns does not upload your chat content, does not read your account information, and does not send conversation data to any external server.
